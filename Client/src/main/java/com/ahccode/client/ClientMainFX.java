...
import com.ahccode.client.gui.network.ClientConnectUI;
...
import static com.ahccode.client.gui.daketi.DaketiGameFinishedScreen.GameResult.WIN;
...
//        testEndScreen(stage);
            ...
            if (e.isControlDown() && e.getCode() == KeyCode.Q) {
                try {
                    if ( !(scene.getRoot() instanceof ClientConnectUI))
                        ClientContext.currentPlayer.getAssociatedClient().send(new Message(MessageType.PLAYER_LEFT, null));
                    System.exit(0);
    ...
    public static void clearAll() throws IOException {
        ...
        if (ClientContext.currentPlayer != null)
            ClientContext.currentPlayer.clear();
        ClientContext.currentPlayer = null;
