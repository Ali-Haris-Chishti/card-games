...
public class CardInHandBox extends CardBox {
    ...
    private void initializeBox(String playerName) {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            if (playerNumber != -1 && playerNumber == ClientContext.currentPlayer.getPlayerNumber()) {
                log.info("Handling Mouse event for Player {}", ClientContext.currentPlayer.getPlayerNumber());
