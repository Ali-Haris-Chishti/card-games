package com.ahccode.client.gui.network;
...
public class ClientConnectUI extends StackPane {
    ...
    private ClientConnectUI(Stage stage, Scene scene) throws IOException {
        ...
        log.info("file:///{}\\assets\\icons\\Game.png", System.getProperty("user.dir"));
            ...
            protected void succeeded() {
                Platform.runLater(() -> {
                    try {
                        ...
                        ClientContext.currentPlayer = player;
                        ClientContext.gameInfo = new GameInfo(name, host, port);
    ...
    public static ClientConnectUI getInstance(Stage stage, Scene scene, boolean direct) throws IOException {
        if (instance == null) {
            ...
            Platform.runLater(() -> {
                ...
                if (direct) {
                    instance.nameField.setText(ClientContext.gameInfo.getName());
                    instance.hostField.setText(ClientContext.gameInfo.getHost());
                    instance.portField.setText(String.valueOf(ClientContext.gameInfo.getPort()));
